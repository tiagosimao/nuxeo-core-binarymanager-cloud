...
public class AmazonS3Client {
    ...
    private AmazonS3Client(AmazonS3 amazonS3, String bucketName, String bucketNamePrefix,
            boolean useServerSideEncryption, String serverSideKMSKeyID) {
    ...
    public static class Builder {
        ...
        public AmazonS3Client build() {
            ...
            String bucketNamePrefix = MoreObjects.firstNonNull(getProperty(BUCKET_PREFIX_PROPERTY), StringUtils.EMPTY);
            ...
            AwsClientBuilder s3Builder = getAWSClientBuilder();

            s3Builder.withCredentials(buildAWSCredentials()).withClientConfiguration(buildClientConfiguration());
            ...
            return new AmazonS3Client((AmazonS3) s3Builder.build(), bucketName, bucketNamePrefix,
         ...
         * @since 10.2
         */
        protected AwsClientBuilder getAWSClientBuilder() {
